...
class Gui():
    ...
    def __init__(self, window):
        ...
        self.entNome = Entry(window, textvariable=self.txtNome, width=Gui.width_entry)
        self.entSobrenome = Entry(window, textvariable=self.txtSobrenome, width=Gui.width_entry)
        self.entEmail = Entry(window, textvariable=self.txtEmail, width=Gui.width_entry)
        self.entCPF = Entry(window, textvariable=self.txtCPF, width=Gui.width_entry)
        ...
        self.btnDel = Button(window, text="Deletar selecionados")
